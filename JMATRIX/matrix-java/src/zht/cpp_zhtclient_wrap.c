...
extern "C" {
#endif
SWIGINTERN const char *_wrap_ZHTClient_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewInstanceObj(SWIG_as_voidptr(&ZHTClient), SWIGTYPE_p_class, 0 );
  if (value) {
...
SWIGINTERN const char *_wrap_ZHTClient_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  if (!value) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""ZHTClient""' of type '""class""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""ZHTClient""' of type '""class""'");
    } else {
      ZHTClient = *((class *)(argp));
    }
  }
  return NULL;
fail:
...
static swig_var_info swig_variables[] = {
    { SWIG_prefix "ZHTClient", 0, (swig_variable_func) _wrap_ZHTClient_get,(swig_variable_func) _wrap_ZHTClient_set},
    {0,0,0,0}
};
